...
- **A1 🐞 Font-size preference silently broken on comma-decimal locales** (major, verified)
  ...
  **Status: 🟢 branch `fable/reader-css-fixes`**
...
- **A2 🐞 Rotating the phone mid-article throws away your reading position** (major, verified)
  ...
  from that. **Status: 🟢 branch `fable/reader-restore`**
...
- **A3 🐞 Articles shorter than one screen never report progress — "Done · Next" never appears** (minor, verified)
  ...
  **Status: 🟢 branch `fable/reader-restore`**
...
- **A4 🐞 Footnote / in-page anchor links kick you out to the browser at your server's root** (major, verified)
  ...
  **Status: 🟢 branch `fable/reader-links`**
...
- **A5 🐞 `mailto:` links replace the article with a `net::ERR_UNKNOWN_URL_SCHEME` error page** (minor, verified)
  ...
  `ACTION_VIEW` and return `true`. **Status: 🟢 branch `fable/reader-links`**
...
- **A8 🐞 Rapid page turns run overlapping scroll animations that fight each other** (minor, verified)
  ...
  page-turn cancels the old animation. **Status: 🟢 branch `fable/reader-links`**
...
- **A11 🐞 Reopening a half-read article yanks the chrome away immediately** (polish, verified)
  ...
  restore. **Status: 🟢 branch `fable/reader-restore`**
...
- **B1 🐞 A still-processing article gets cached empty and never heals** (major, verified)
  ...
  **Status: 🟢 branch `fable/article-cache`**
...
- **B2 🐞 An offline archive/favourite queued in the outbox can revert a newer online change** (major, verified)
  ...
  **Status: 🟢 branch `fable/outbox-robustness`**
...
- **B3 🐞 Outbox ops are silently dropped after ~8 minutes of server unreachability** (major, verified)
  ...
  against the cap. **Status: 🟢 branch `fable/outbox-robustness`**
...
- **B4 🐞 Closing the reader fast can lose an archive tap entirely** (minor, verified)
  ...
  `withContext(NonCancellable)`. **Status: 🟢 branch `fable/outbox-robustness`**
...
- **B8 🐞 A malformed server URL crashes the app during onboarding** (critical, verified)
  ...
  `normalizeBaseUrl`. **Status: 🟢 branch `fable/connection-crash`**
...
- **B9 🐞 "Only on Wi-Fi" triggers an immediate download over mobile data** (major, verified)
  ...
  **Status: 🟢 branch `fable/offline-wifi-only`**
...
- **B10 🐞 Sign-out leaves the outbox, progress, and stats behind** (minor, verified)
  ...
  workers. **Status: 🟢 branch `fable/signout-share`**
...
- **B11 🐞 Share-to-save blocks the host app and can silently lose the link** (minor, verified)
  ...
  the outcome. **Status: 🟢 branch `fable/signout-share`**
...
- **B12 🐞 "Saved to Karakeep ✓" even when adding to your read-later list failed** (minor, verified)
  ...
  toast. Fix: report the partial failure. **Status: 🟢 branch `fable/signout-share`**
...
- **B13 🐞 Transient image errors are force-cached for a year** (minor, verified)
  ...
  responses. **Status: 🟢 branch `fable/auth-scope`**
...
- **B14 🐞 Paging source converts cancellation into an error state** (minor, verified)
  ...
  anti-pattern. Fix: rethrow cancellation. **Status: 🟢 branch `fable/list-fixes`**
...
- **B15 🐞 Failover retries non-idempotent POSTs — duplicate saves** (minor, verified)
  ...
  idempotent methods. **Status: 🟢 branch `fable/auth-scope`**
...
- **C1 🐞 The Library silently jumps back to the read-later tab on any settings write** (major, verified)
  ...
  and only auto-switch on the first load. **Status: 🟢 branch `fable/library-tab-guard`**
...
- **C2 🐞 Double-tapping a card opens the article twice** (minor, verified)
  ...
  **Status: 🟢 branch `fable/nav-insets`**
...
- **C3 🐞 Every tab screen pads for the status bar twice** (major, verified — visible in `screenshots/home.jpeg`)
  ...
  handles its own insets). **Status: 🟢 branch `fable/nav-insets`**
...
- **C4 🐞 Pull-to-refresh is impossible exactly where you need it — empty states** (major, verified)
  ...
  empty/error branches scrollable. **Status: 🟢 branch `fable/list-fixes`**
...
- **C5 🐞 Swipe actions can act on a stale bookmark after a refresh** (minor, verified)
  ...
  **Status: 🟢 branch `fable/list-fixes`**
...
- **C8 🐞 Toolbar "Surprise me" can crash on an emptied list** (minor, verified)
  ...
  and tap throws on an empty range. **Status: 🟢 branch `fable/nav-insets`**
...
- **C9 🐞 Search results offer no archive/favourite at all** (minor, verified)
  ...
  **Status: 🟢 branch `fable/search-actions`**
...
- **C10 🐞 Stats' "today" goes stale after midnight** (minor, verified)
  ...
  midnight ticker into the flow. **Status: 🟢 branch `fable/stats-midnight`**
...
- **C11 🐞 TTS volume can't be adjusted — volume keys page instead** (major, verified; three reviewers found this independently)
  ...
  while `speech.active`. **Status: 🟢 branch `fable/tts-fixes`**
...
- **D1 🐞 TTS can hang (or die) on CJK and unpunctuated articles** (major, verified)
  ...
  length. **Status: 🟢 branch `fable/tts-fixes`**
...
- **D3 🔥 Every TTS start/skip/rate-change floods thousands of binder calls** (major, verified)
  ...
  utterances, refilled from `onDone`). **Status: 🟢 branch `fable/tts-fixes`**
...
- **D4 🐞 Audio-focus denial is ignored — narration talks over phone calls** (minor, verified)
  ...
  don't start when focus is denied. **Status: 🟢 branch `fable/tts-fixes`**
...
- **D5 🐞 Skip while paused unexpectedly resumes playback** (polish, verified)
  ...
  state, just move the index. **Status: 🟢 branch `fable/tts-fixes`**
...
- **D6 🎨 The listen bar's ±10-second icons perform one-sentence skips** (polish, verified)
  ...
  match. **Status: 🟢 branch `fable/tts-fixes`**
...
- **D7 🐞 Highlight exports collide across articles with the same title** (major, verified)
  ...
  short stable hash of the bookmark id. **Status: 🟢 branch `fable/highlights-fixes`**
...
- **D8 🐞 Highlight delete/note failures are silent and never reverted** (minor, verified)
  ...
  **Status: 🟢 branch `fable/highlights-fixes`**
...
- **D10 🐞 The Highlights screen shows stale data after editing in the reader** (minor, verified)
  ...
  Fix: refresh on resume. **Status: 🟢 branch `fable/highlights-fixes`**
...
- **D11 🔥 Highlights screen fires an unbounded parallel request per article** (minor, verified)
  ...
  servers. Fix: bound the concurrency. **Status: 🟢 branch `fable/highlights-fixes`**
...
- **E1 🔥 The scroll listener does an O(article-length) DOM walk on every frame** (major, verified)
  ...
  search per frame. **Status: 🟢 branch `fable/perf-scroll`**
...
- **E2 🔥 Every scroll frame recomposes the whole reader** (major, verified)
  ...
  **Status: 🟢 branch `fable/perf-scroll`**
...
- **E3 🔥 Jsoup sanitization of the full article runs on the main thread, inside composition, during the open transition** (major, verified)
  ...
  a background dispatcher in the ViewModel. **Status: 🟢 branch `fable/perf-article-open`**
...
- **E4 🔥 Opening an article parses the same HTML with Jsoup three times** (major, verified)
  ...
  **Status: 🟢 branch `fable/perf-article-open`**
...
- **E5 🔥 Every article open pays a redundant bookmark GET before highlights load** (minor, verified)
  ...
  reconcile flags when served from cache. **Status: 🟢 branch `fable/perf-article-open`**
...
- **E7 🔥 List keys use `get()` instead of `peek()`** (minor, verified)
  ...
  no `contentType`. **Status: 🟢 branch `fable/list-fixes`**
...
- **F1 🎨 Highlighted text is near-illegible in Dark/Black themes** (major, verified)
  ...
  + an rgba fallback line. **Status: 🟢 branch `fable/reader-css-fixes`**
...
- **F2 🎨 Reader body text ignores the system font-size setting** (major, verified)
  ...
  multiply the base size by `fontScale`. **Status: 🟢 branch `fable/reader-css-fixes`**
...
- **F3 🎨 Sepia's secondary text misses WCAG AA — and styles whole blockquotes** (minor, verified — 4.44:1)
  ...
  clears it while staying warm. **Status: 🟢 branch `fable/reader-css-fixes`**
...
- **F4 🎨 Status-bar icons don't follow the in-app theme override** (major, verified)
  ...
  **Status: 🟢 branch `fable/status-bar-theme`**
...
- **F5 🎨 White flash on activity recreation in dark mode** (minor, verified)
  ...
  UI. OLED night readers feel this one. **Status: 🟢 branch `fable/status-bar-theme`**
...
- **F7 🎨 Reader-controls rows are broken for TalkBack** (minor, verified)
  ...
  **Status: 🟢 branch `fable/a11y-controls`**
...
- **F11 🎨 Reader HTML hardcodes `lang="en"`** (minor, verified)
  ...
  Unknown beats wrong: drop the attribute. **Status: 🟢 branch `fable/reader-links`**
...
- **F12 🎨 Onboarding ignores status-bar/cutout insets in landscape** (polish, verified)
  ...
  **Status: 🟢 branch `fable/connection-crash`**
...
- **G1 🔐 The bearer token is attached by host-only match — scheme and port ignored** (major, verified)
  ...
  **Status: 🟢 branch `fable/auth-scope`**
...
- **G2 🔐 HTTP request logging is active in release builds** (minor, verified)
  ...
  `BuildConfig.DEBUG`. **Status: 🟢 branch `fable/auth-scope`**
...
- **H2 ✨ Tag chips on cards** (upgrade of deferred B3)
  ...
  aids triage without breaking the calm. **Status: 🟢 branch `fable/tag-chips`**
...
- **H3 ✨ An "Auto" reader theme following the system** (upgrade of deferred D5)
  ...
  **Status: 🟢 branch `fable/auto-theme`**

- **H4 ✨ "Finish by ~9:42 pm"** (deferred D2, now unblocked — PR #29 merged)
  Next to "12 min left" in the reader bar. **Status: 🟢 branch `fable/perf-scroll`**
...
|---|---|---|
| `fable/connection-crash` | B8, F12 | repository, ApiProvider, onboarding |
| `fable/reader-css-fixes` | A1, F1, F2, F3 | ReaderHtmlBuilder, ReaderWebView |
| `fable/article-cache` | B1, B7 | KarakeepRepository |
| `fable/offline-wifi-only` | B9 | SettingsViewModel, OfflineSync |
| `fable/outbox-robustness` | B2, B3, B4, B5, B6 | KarakeepRepository, Daos, LibraryViewModel |
| `fable/tts-fixes` | D1–D6, C11 | ArticleSpeaker, ReaderScreen |
| `fable/reader-restore` | A2, A3, A9, A10, A11 | ReaderViewModel, ReaderScreen, ReaderWebView, ReaderHtmlBuilder |
| `fable/reader-links` | A4, A5, A6, A8, F11 | ReaderHtmlBuilder, ReaderWebView |
| `fable/nav-insets` | C2, C3, C7, C8 | Navigation, LibraryScreen, ListBookmarksViewModel |
| `fable/library-tab-guard` | C1 | LibraryViewModel |
| `fable/list-fixes` | C4, C5, C6, E7, F10, B14 | BookmarkList, MessageStack, Common, BookmarksPagingSource |
| `fable/auth-scope` | G1, G2, B13, B15, J2 | ApiProvider, AssetLoader, backup_rules |
| `fable/highlights-fixes` | D7–D12 | ReaderViewModel, HighlightsViewModel/Screen, ReaderScreen, DocumentTreeWriter, HighlightsExport |
| `fable/signout-share` | B10, B11, B12 | SettingsViewModel, ShareActivity, KarakeepRepository, Daos |
| `fable/perf-scroll` | E1, E2, H4 | ReaderHtmlBuilder (JS), ReaderScreen |
| `fable/perf-article-open` | E3, E4, E5, E9 | ReaderViewModel, Mappers, ReaderWebView |
| `fable/search-actions` | C9, F9 | SearchViewModel, SearchScreen |
| `fable/status-bar-theme` | F4, F5 | MainActivity, res/values(-night) |
| `fable/a11y-controls` | F7, F8 | ReaderControls, SettingsScreen |
| `fable/stats-midnight` | C10 | StatsViewModel |
| `fable/auto-theme` | H3 | Models, SettingsRepository, ReaderScreen, ReaderControls |
| `fable/tag-chips` | H2 | BookmarkCard |

*(This table is written at commit time as the plan of record; statuses above are
updated as branches land as PRs.)*
